...
plugins=(cabal colored-man colorize common-aliases cp dircycle dirhistory
         extract fasd git git-extras git-prompt github gitignore
         history-substring-search python rand-quote safe-paste sprunge ssh-agent
